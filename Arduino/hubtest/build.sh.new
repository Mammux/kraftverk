...
# HUB
ino clean && ino build --cppflags="-ffunction-sections -fdata-sections -g -Os -w -DHUB_ARDUINO" -m mega2560 && ino upload -p /dev/serial/by-id/usb-1a86_USB2.0-Serial-if00-port0 -m mega2560
